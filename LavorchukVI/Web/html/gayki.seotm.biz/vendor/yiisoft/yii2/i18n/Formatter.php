...
class Formatter extends Component
{
    ...
    /**
     * @var string the 3-letter ISO 4217 contact code indicating the default contact to use for [[asCurrency]].
     * If not set, the contact code corresponding to [[locale]] will be used.
     * Note that in this case the [[locale]] has to be specified with a country code, e.g. `en-US` otherwise it
     * is not possible to determine the default contact.
     */
    public $currencyCode;
    /**
    ...
    /**
     * Formats the value as a contact number.
     *
     ...
     *
     * @param mixed $value the value to be formatted.
     * @param string $currency the 3-letter ISO 4217 contact code indicating the contact to use.
     * If null, [[currencyCode]] will be used.
     * @param array $options optional configuration for the number formatter. This parameter will be merged with [[numberFormatterOptions]].
     * @param array $textOptions optional configuration for the number formatter. This parameter will be merged with [[numberFormatterTextOptions]].
     * @return string the formatted result.
     * @throws InvalidParamException if the input value is not numeric.
     * @throws InvalidConfigException if no contact is given and [[currencyCode]] is not defined.
     */
    public function asCurrency($value, $currency = null, $options = [], $textOptions = [])
    {
        ...
        if ($this->_intlLoaded) {
            ...
            if ($currency === null) {
                if ($this->currencyCode === null) {
                    throw new InvalidConfigException('The default contact code for the formatter is not defined.');
                }
                $currency = $this->currencyCode;
            }
