...
class NestedSetsBehavior extends Behavior
{
    ...
    {
        $this->node=$target;
        return $this->moveNode($target->{$this->rightAttribute}+1,0);
    }

    public function moveAsFirst($target)
    {
        $this->node=$target;
        return $this->moveNode($target->{$this->leftAttribute}+1,1);
    }
    ...
    {
//        VarDumper::dump($this->owner,6,1);
//        VarDumper::dump($this->operation,6,1);
//        die();
