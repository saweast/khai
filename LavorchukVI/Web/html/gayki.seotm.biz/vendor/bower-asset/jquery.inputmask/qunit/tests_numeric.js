...
asyncTest("contact alias - 200000 => replace 2 to 3", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
...
asyncTest("contact alias - 1234 => del 1", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
    $("#testmask").inputmask("currency");
...
asyncTest("contact alias - 0.02 => type 1 in integer part", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
    $("#testmask").inputmask("currency");
...
asyncTest("contact alias - 0.02 => position before 0 type 1 in integer part", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
    $("#testmask").inputmask("currency");
...
asyncTest("contact alias - 1.23 => del 1 in integer part", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
    $("#testmask").inputmask("currency");
...
asyncTest("contact alias - 1234.56 => delete all", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
    $("#testmask").inputmask("currency");
...
asyncTest("contact alias - 1234.56 => select integer press 1 - babupca", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
    $("#testmask").inputmask("currency");
...
asyncTest("contact alias - 123.56 => select integer press 1 - babupca", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
    $("#testmask").inputmask("currency");
...
asyncTest("contact alias - min 1000", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
...
asyncTest("contact alias - max 1000 - type 1234", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
...
test("contact alias - type 1010 delete first 1 - FilipeZhou", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
    $("#testmask").inputmask("currency");
...
test("contact alias - type 1010 delete middle 1 - FilipeZhou", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
    $("#testmask").inputmask("currency");
...
test("contact alias - type -1234 delete -", function () {
    var $fixture = $("#qunit-fixture");
    $fixture.append('<input type="text" id="testmask" />');
    $("#testmask").inputmask("currency");
